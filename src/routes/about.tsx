...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Us — Klipnova Solutions" },
      {
        name: "description",
        content: "Learn more about Klipnova Solutions. We deliver customized IT and digital solutions to help your modern business grow.",
      },
    ],
  }),
  component: About,
...
function About() {
  return (
    <KlipnovaLayout>
      ...
      <div className="container-fluid bg-primary py-5 bg-header" style={{ marginBottom: "90px" }}>
        <div className="row py-5">
          <div className="col-12 pt-lg-5 mt-lg-5 text-center">
            ...
            <span className="h5 text-white">About</span>
          </div>
        </div>
      </div>
      {/* Page Header End */}
      ...
      {/* Vendor List (Static grid fallback for owl carousel if javascript isn't active) */}
      <div className="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
