    ...
    Tables: {
      ...
      travel_sessions: {
        Row: {
          ...
          id: string;
          session_total_duration: number | null;
          session_total_km: number | null;
          ...
          travel_start_address: string | null;
          travel_start_latitude: number | null;
          travel_start_longitude: number | null;
          travel_start_time: string | null;
          travel_status: string | null;
          travel_stop_address: string | null;
          travel_stop_latitude: number | null;
          travel_stop_longitude: number | null;
          travel_stop_time: string | null;
          updated_at: string;
        };
        Insert: {
          attendance_id?: string | null;
